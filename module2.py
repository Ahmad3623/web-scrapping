...
#for i in range(len(party)):
            ...
            #min_m=i
            #min_margin=margin[i]
#print ("There is a high possibility of " + val3 + " winning in "+ name[min_m] + " in next Election")
#print ("There is a low possibility of " + val3 + " winning in " + name[max_m] + " in next Election")
#print ("These Are The Places Where " +val3+ "  Can Win in the Next Election "  )
